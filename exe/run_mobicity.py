...
if "--rafael" in sys.argv:
    addresses = {
        "home": "R. Araguaia, 1613 - Freguesia de Jacarepaguá, Rio de Janeiro - RJ, 22745-271, Brasil",
        "work_front": "Av. Henrique3 Valadares, 26 - Lapa, Rio de Janeiro - RJ, 20231-030, Brazil",
        "work_back": "R. do Senado, 115 - Centro, Rio de Janeiro - RJ, 20231-000, Brazil",
        "fair": "R. Joaquim Pinheiro, 16 - Freguesia de Jacarepaguá, Rio de Janeiro - RJ, 22743-660, Brazil",
        "crossfit": "R. Araguaia, 895 - Freguesia de Jacarepaguá, Rio de Janeiro - RJ, 22745-270, Brasil"
    }

    shift = "day" if argv.get("turno", "day").lower()=="dia" else "night"

    time_to_work = {"day": "05:55",
                    "night": "17:55"}[shift]
    time_to_home = {"day": "19:05",
                    "night": "07:05"}[shift]
    ...
    m = Mobicity(
        ...
        time_to_work=time_to_work,
        time_to_home=time_to_home,
        start_day="01/11/2024",
        days=6,
        **addresses
    )
    m.browser_name = "edge"

    # Inserindo exceções por dia da semana
    if m.shift == "day":
    ...
    print(m)
    m.setup_rides(
        "rafael_matos@petrobras.com.br",
        getpass("Senha do Mobicity (não é a senha Petrobras): ")
    )

    # addresses = {
    #     "home": "Rua Barão de Ipanema, 29. Copacabana. Rio de Janeiro",
    #     "work_front": "Av. Henrique Valadares, 28 - Lapa, Rio de Janeiro - RJ, 20231-030, Brazil",
    #     "work_back": "R. do Senado, 115 - Centro, Rio de Janeiro - RJ, 20231-000, Brazil",
    #     "fair": "R. Joaquim Pinheiro, 16 - Freguesia de Jacarepaguá, Rio de Janeiro - RJ, 22743-660, Brazil",
    #     "crossfit": "R. Araguaia, 895 - Freguesia de Jacarepaguá, Rio de Janeiro - RJ, 22745-270, Brasil"
    # }
    # shift = ["day", "night"][1]
    # time_to_work = {"day": "06:25",
    #                 "night": "18:15"}[shift]
    # time_to_home = {"day": "19:30",
    #                 "night": "07:30"}[shift]
    # m = Mobicity(
    #     shift=shift,
    #     time_to_work=time_to_work,
    #     time_to_home=time_to_home,
    #     start_day="02/10/2024",
    #     days=6,
    #     **addresses
    # )
    # m.browser_name = "edge"
    # if m.shift == "day":
    #     m.setup_schedule_weekdays("to_work", [0, 1, 2, 3, 4, 5, 6], home="home", work="work_front")
    #     m.setup_schedule_weekdays("to_home", [0, 1, 2, 3, 4, 5, 6], home="home", work="work_front")
    # else:
    #     m.setup_schedule_weekdays("to_work", [0, 1, 2, 3, 4, 5, 6], home="home", work="work_front")
    #     m.setup_schedule_weekdays("to_home", [0, 1, 2, 3, 4, 5, 6], home="home", work="work_front")
    # m.setup_rides("arraesff@petrobras.com.br", getpass("Senha do Mobicity (não é a senha Petrobras): "))
